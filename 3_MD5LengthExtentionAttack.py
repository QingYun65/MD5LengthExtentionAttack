...
class MD5(object):
    # 初始化密文
    def __init__(self, message, A=0x67452301, B=0xEFCDAB89, C=0x98BADCFE, D=0x10325476):
...
print("MD5正确性测试：")
message="hello world"
MD5_test = MD5(message)
t_1=MD5_test.fill_text()
result = MD5_test.group_processing()
print(result)
test_data="hello world".encode()
hash_obj=hashlib.md5(test_data)
print(hash_obj.hexdigest()) 



print("长度拓展攻击：")
secret_data="hello world".encode()              #首先由hashlib得到secret_data的hash值
hash_obj=hashlib.md5(secret_data)               #返回字符型digest
digest_1=hash_obj.hexdigest()                   #转换成字节,5eb63bbb e01eeed0 93cb22bb 8f5acdc3
print(digest_1)
choose_data="zzz"                               #添加数据，长度拓展
Attack=MD5(choose_data,A=0x5eb63bbb,B=0xe01eeed0,C=0x93cb22bb,D=0x8f5acdc3)
t_2=Attack.fill_text()
attack = Attack.group_processing()
print(attack)
#根据secret_data构造真正的输入，但是需要注意的是t_1不需要任何改动，而t_2的长度需要重新赋值
t=t_1+t_2
t=hex(int(t,2))
t=t[2:]
print(t)
t=t[:240]
t=t+'8600000000000000'
print(t)
#t=bin(int(t,16))
